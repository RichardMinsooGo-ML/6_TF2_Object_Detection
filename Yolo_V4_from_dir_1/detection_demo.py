...
detect_image(yolo, image_path, "./IMAGES/kite_pred_darknet.jpg", input_size=YOLO_INPUT_SIZE, show=True, rectangle_colors=(255,0,0))
# detect_video(yolo, video_path, "./IMAGES/output_test_darknet.mp4", input_size=YOLO_INPUT_SIZE, show=False, rectangle_colors=(255,0,0))
