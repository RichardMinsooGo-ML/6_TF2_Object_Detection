...
YOLO_V4_WEIGHTS             = "../00_Darknet_Weights/yolov4.weights"
YOLO_V3_TINY_WEIGHTS        = "../00_Darknet_Weights/yolov3-tiny.weights"
YOLO_V4_TINY_WEIGHTS        = "../00_Darknet_Weights/yolov4-tiny.weights"
...
if dataset_name == "1K_MNIST":
    ...
    TRAIN_CHECKPOINTS_FOLDER    = "../checkpoints/V4_weight_MNIST"
    ...
    TRAIN_CHECKPOINTS_FOLDER    = "../checkpoints/V4_weight_fashion_MNIST"
    ...
    TRAIN_CHECKPOINTS_FOLDER    = "../checkpoints/V4_weight_VOC"
    ...
    TRAIN_CHECKPOINTS_FOLDER    = "../checkpoints/V4_weight_COCO"
    ...
    TRAIN_CHECKPOINTS_FOLDER    = "../checkpoints/V4_weight_OID_30_cls"
    DATA_TYPE = "yolo_v4_OID_30_cls"
